...
<div class="asrama-wrapper">
    ...
    <div class="asrama-stats-grid">
        <div class="asrama-stat-card">
            <div class="stat-card-icon" style="background: rgba(99, 102, 241, 0.15); border: 1px solid rgba(99, 102, 241, 0.35); color: #818cf8; width: 34px; height: 34px; border-radius: 8px; display: flex; align-items: center; justify-content: center; margin-bottom: 0.4rem;">
        ...
        <div class="asrama-stat-card">
            ...
            <h3 style="color: #38bdf8; margin: 0.2rem 0 0 0; font-size: 1.45rem; font-weight: 800;">{{ $summary['kamar_tersedia'] }} <span style="font-size: 0.82rem; color: #94a3b8; font-weight: 500;">Unit</span></h3>
        </div>
        <div class="asrama-stat-card">
